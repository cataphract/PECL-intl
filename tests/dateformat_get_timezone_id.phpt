...
function ut_main()
{
	...
	{
		$res_str .= "\nCreating DateFormatter with timezone_id = $timezone_id_entry";
		$fmt = ut_datefmt_create( "de-DE",  DateFormatter::SHORT, DateFormatter::SHORT, $timezone_id_entry , DateFormatter::GREGORIAN  );
...
?>
--EXPECT--
Creating DateFormatter with timezone_id = America/New_York
After call to get_timezone_id :  timezone_id= America/New_York

Creating DateFormatter with timezone_id = America/Los_Angeles
After call to get_timezone_id :  timezone_id= America/Los_Angeles

Creating DateFormatter with timezone_id = America/Dallas
